 ...
 * <p>暴露：
 * <ul>
 *   <li>{@link MqttMQProperties} —— mqtt 特有配置（从 MicroProfile Config 读取）</li>
 *   <li>{@link MqttMQClient} —— {@link MQClient} 实现，供 {@link io.ddd4j.quarkus.mq.core.QuarkusMQListenerRegistrar} 使用</li>
 * </ul>
 *
...
public class MqttMQCdiProducer {
    ...
    @Singleton
    @DefaultBean
    public MQClient mqClient(MqttMQClient client) {
        return client;
    }
}
