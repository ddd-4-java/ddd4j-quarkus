 ...
 * <p>暴露：
 * <ul>
 *   <li>{@link DisruptorMQProperties} —— disruptor 特有配置（从 MicroProfile Config 读取）</li>
 *   <li>{@link DisruptorMQClient} —— {@link MQClient} 实现，供 {@link io.ddd4j.quarkus.mq.core.QuarkusMQListenerRegistrar} 使用</li>
 * </ul>
 *
...
public class DisruptorMQCdiProducer {
    ...
    @Singleton
    @DefaultBean
    public MQClient mqClient(DisruptorMQClient client) {
        return client;
    }
}
