 ...
 *   <li>容器连接信息已由共享 fixture {@link DisruptorQuarkusTestResource} 注入到 application.properties</li>
 * </ul>
 *
 * <p>测试使用内嵌 {@link DisruptorTestResource}（委托 {@link DisruptorQuarkusTestResource} 的 start/stop）启动对应容器，
...
class DisruptorQuarkusIntegrationTest {
