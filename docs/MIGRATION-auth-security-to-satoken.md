...
**Status**: `ddd4j-quarkus-auth-security` is deprecated since **4.1.0** and scheduled for removal in **5.0.0**.
...
- The `ddd4j-quarkus-auth-security` module remains available in 4.x.y versions
- Binary compatibility is preserved (no API breakage in 4.x)
- Removal targeted for 5.0.0 (estimated 2026-Q4)
